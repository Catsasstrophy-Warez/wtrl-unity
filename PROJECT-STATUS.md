...
- 137/137 EditMode tests, 23/23 PlayMode tests, all passing.
...
- A `MarshVehicle` AI opponent drives the same physics under
  ...
  `RivalIntimidationState` — nothing currently does, since no contact/
  win-detection system feeds it real data yet.
